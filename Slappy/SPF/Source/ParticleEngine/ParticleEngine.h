...
class CEmitter
{
	private:
		...
		//This emitters base object
		//Used to attach emitters to base objects
		CBaseObject *pMyBaseObject;
	...
	public:
		...
		CEmitter(EmitterStuffT *myEmitterStuff, float fRed = 1.0f, float fGreen = 1.0f, float fBlue = 1.0f)
		{
			m_EmitterStuff = myEmitterStuff;
			fColor[0] = fRed;
			fColor[1] = fGreen;
			fColor[2] = fBlue;
		}
...
class CParticleEngine
{
	...
	public:
		...
		//
		/////////////////////////////////////////////////////////////////////////*/
		void CreateEmitter(int iEmitterType, Vec4DT *Position, Vec4DT *Velocity = 0, CBaseObject *pAttachObject = 0, float *pRGB = 0);
